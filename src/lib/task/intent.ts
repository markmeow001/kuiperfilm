...
const TASK_INTENT_BY_TYPE: Record<TaskType, TaskIntent> = {
  ...
  [TASK_TYPE.VISUAL_DEVELOPMENT_SCRIPT_ANALYSIS]: 'analyze',
  [TASK_TYPE.VISUAL_DEVELOPMENT_STAGE_BRIEF]: 'build',
  ...
  [TASK_TYPE.CANVAS_SHOT_PROMPTS]: 'build',
  [TASK_TYPE.CANVAS_TTS]: 'generate',
  [TASK_TYPE.CANVAS_COMPOSE_VIDEO]: 'process',
  [TASK_TYPE.CANVAS_STORYBOARD_EXPORT]: 'process',
}
