...
const VIDEO_TYPES = new Set<TaskType>([TASK_TYPE.VIDEO_PANEL, TASK_TYPE.LIP_SYNC, TASK_TYPE.VIDEO_MULTI_SHOT, TASK_TYPE.VIDEO_EDITOR_RENDER, TASK_TYPE.EPISODE_STITCH_MP4, TASK_TYPE.PLAYGROUND_VIDEO, TASK_TYPE.CANVAS_COMPOSE_VIDEO, TASK_TYPE.CANVAS_STORYBOARD_EXPORT])
