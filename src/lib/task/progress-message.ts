...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.AUTO_GROUP_MULTI_SHOT]: 'progress.taskType.autoGroupMultiShot',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  auto_group_prepare: 'progress.stage.autoGroupPrepare',
  auto_group_persist: 'progress.stage.autoGroupPersist',
