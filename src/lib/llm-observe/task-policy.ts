...
const POLICY_BY_TASK_TYPE: Partial<Record<TaskType, LLMTaskPolicy>> = {
  [TASK_TYPE.AUTO_GROUP_MULTI_SHOT]: LLM_STANDARD_POLICY,
  [TASK_TYPE.REGENERATE_STORYBOARD_TEXT]: LONG_FLOW_HIGH_POLICY,
  [TASK_TYPE.INSERT_PANEL]: LLM_STANDARD_POLICY,
  [TASK_TYPE.CANVAS_STORYBOARD]: LLM_STANDARD_POLICY,
  [TASK_TYPE.CANVAS_DIRECTOR_ROUTES]: LLM_STANDARD_POLICY,
  [TASK_TYPE.CANVAS_DIRECTOR_BLOCKING]: LLM_STANDARD_POLICY,
  [TASK_TYPE.CANVAS_TEXT]: LLM_STANDARD_POLICY,
  // Non-LLM CPU task: explicit default policy registration.
  [TASK_TYPE.CANVAS_COMPOSE_VIDEO]: DEFAULT_POLICY,
  [TASK_TYPE.CANVAS_STORYBOARD_EXPORT]: DEFAULT_POLICY,
