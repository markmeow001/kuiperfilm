...
export function parseJsonUnknown(raw: string | null | undefined): unknown | null {
  if (!raw) return null
  try {
...
export function parseDescriptionList(raw: string | null | undefined): string[] {
  if (!raw) return []
  try {
...
export function pickAppearanceDescription(appearance: {
...
export function buildPanelPrompt(params: {
  ...
  return buildPrompt({
    ...
    variables: {
      ...
      storyboard_text_json_input: params.sceneText,
