...
export const IMAGE_RECIPES: ImageRecipe[] = [
  ...
  { key: 'emotion-tune', group: '质感调节', label: '情绪调节', prompt: '调整人物的面部情绪表达为：______（如 隐忍的愤怒 / 强装镇定 / 喜极而泣），只改表情与微表情，五官、造型、构图、光线保持完全一致' },
  { key: 'relight', group: '质感调节', label: '打光调整', prompt: '重新为画面打光：主光源来自______方向，色温偏______（暖/冷），在人物面部形成______（伦勃朗光/蝴蝶光/侧逆光），背景光比压暗一档，内容与构图保持不变' },
  // 空间与机位
