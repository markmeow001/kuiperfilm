...
export function LiveCompositeWorkflowGuide({ activeStep, completedSteps, onStepChange }: LiveCompositeWorkflowGuideProps) {
  ...
  return (
    <section className="border-b border-white/10 bg-[#0d1115] px-4 py-4" aria-label="實拍合成步驟">
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="text-[11px] font-medium uppercase tracking-[0.18em] text-cyan-300">Step {String(activeStep).padStart(2, '0')} / 06</div>
