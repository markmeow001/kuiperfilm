...
beforeEach(() => {
  ...
  prismaMock.task.findMany.mockResolvedValue([
    { id: 'img-1', status: 'completed', result: { resultUrls: ['images/playground-runs/a.jpg'] } },
    { id: 'img-2', status: 'completed', result: { resultUrls: ['images/playground-runs/b.jpg'] } },
  ])
...
describe('canvas storyboard export worker', () => {
  ...
  it('middle image missing -> fails whole export before render', async () => {
    prismaMock.task.findMany.mockResolvedValue([{ id: 'img-1', status: 'completed', result: { resultUrls: ['images/playground-runs/a.jpg'] } }])
