...
describe('storyboard export limits and bundle cache', () => {
  it('hard limits -> max 25, 90s timeout, 4K, 2.5GiB RSS default', () => {
    expect(STORYBOARD_EXPORT_LIMITS).toEqual(expect.objectContaining({ maxItems: 25, timeoutMs: 90_000, width: 3840, height: 2160, defaultMaxRssBytes: 2560 * 1024 * 1024 }))
