...
const TASK_TYPE_OWNER_MAP = {
  ...
  [TASK_TYPE.IMAGE_PROP]: 'tests/unit/worker/prop-image-task-handler.test.ts',
  ...
  [TASK_TYPE.VIDEO_MULTI_SHOT]: 'tests/unit/worker/video-worker.test.ts',
  ...
  [TASK_TYPE.CANVAS_SHOT_PROMPTS]: 'tests/unit/worker/canvas-shot-prompts-handler.test.ts',
