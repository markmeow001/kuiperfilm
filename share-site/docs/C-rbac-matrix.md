...
| Role | 描述 |
|---|---|
| **Owner** | workspace 創建者，可刪 workspace |
| **Admin** | 可邀請 / 移除 member、改 billing |
...
| workspace.member.remove（his/herself） | ✓ | ✓ | ✓ | ✓ |
...
| Action | Workspace Owner | Workspace Admin | Workspace Editor | Workspace Viewer |
|---|---|---|---|---|
| project.read | ✓ | ✓ | ✓ | ✓ |
| project.create | ✓ | ✓ | ✓ | ✗ |
| project.write（自己創的） | ✓ | ✓ | ✓ | ✗ |
